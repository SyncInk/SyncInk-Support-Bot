...
class SuccessEmbed(SyncInkEmbed):
    def __init__(self, description: str, **kwargs):
        ...
        self.set_author(name="Action Successful", icon_url="https://cdn.discordapp.com/emojis/1520901996389990440.gif")
...
class ErrorEmbed(SyncInkEmbed):
    def __init__(self, description: str, resolution: str = "Please contact a server administrator if the issue persists.", **kwargs):
        ...
        self.set_author(name="Action Required", icon_url="https://cdn.discordapp.com/emojis/1520901852651323593.gif")
